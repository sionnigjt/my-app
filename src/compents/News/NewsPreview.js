        ...
        {previewInfo && <div>
            ...
            >
                <Descriptions size="small" column={3}>
                    ...
                    <Descriptions.Item label="审核状态" ><span style={{ color: colorList[previewInfo.auditState] }}>{AuditList[previewInfo.auditState]}</span></Descriptions.Item>
                    <Descriptions.Item label="发布状态" ><span style={{ color: colorList[previewInfo.pubilshState] }}>{publishList[previewInfo.pubilshState]}</span></Descriptions.Item>
